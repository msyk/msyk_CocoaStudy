...
#import "SecondPanel.h"


@implementation SecondPanel

- (void) awakeFromNib{	// *****

	NSLog( @"Calling: SecondPanel#awakeFromNib" );
...
{
	NSLog( @"Calling: SecondPanel#tapButton:" );
...
- (void)viewDidLoad {
    [super viewDidLoad];
	[oneButton setTitle: @"Second" forState: UIControlStateNormal];
}
